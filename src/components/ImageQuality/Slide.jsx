    ...
    >
      ...
      <div className="overflow-hidden w-full h-full rounded-[24px] md:rounded-[30px]  ">
        ...
        <Image
          ...
          height={490}
          alt={title}
          className="w-full object-cover object-center aspect-[1000/600] h-full rounded-[24px] md:rounded-[30px] object-cover object-center	origin-center		transition-transform duration-500 cursor-pointer hover:scale-110"
        />
      </div>
